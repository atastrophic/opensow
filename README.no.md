...
brew install anomalyco/tap/opensow # macOS og Linux (anbefalt, alltid oppdatert)
...
OpenSow er også tilgjengelig som en desktop-app. Last ned direkte fra [releases-siden](https://github.com/anomalyco/opensow/releases) eller [opensow.ai/download](https://opensow.ai/download).
