...
Direct planting subagent that collects plants from users who already know what they want to grow. Supports full-season planning or current-window mode, and delegates to crop-data for each plant's agronomic record.
