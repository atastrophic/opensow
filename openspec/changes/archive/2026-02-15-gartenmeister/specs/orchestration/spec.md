...
The gartenmeister prompt SHALL include explicit routing rules that map user intent to subagent delegation. The rules SHALL cover: garden setup, season management, and crop data entry.
