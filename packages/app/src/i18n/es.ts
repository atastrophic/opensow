export const dict = {
  ...
  "command.session.shell": "Ejecutar comando de shell",
  "command.session.shell.description": "Ejecutar un comando de shell",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por OpenSow",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en OpenSow.",
  ...
  "provider.connect.opensowZen.line1":
    "OpenSow Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.opensowZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.opensowZen.visit.prefix": "Visita ",
  "provider.connect.opensowZen.visit.link": "opensow.ai/zen",
  "provider.connect.opensowZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en OpenSow.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en OpenSow.",
  ...
  "dialog.plugins.empty": "Plugins configurados en opensow.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de OpenSow se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de OpenSow ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de OpenSow",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (opensow.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, OpenSow no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "OpenSow incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para OpenSow",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve OpenSow en tu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de OpenSow.",
