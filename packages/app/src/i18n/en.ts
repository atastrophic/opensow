export const dict = {
  ...
  "command.session.shell": "Run shell command",
  "command.session.shell.description": "Execute a shell command",
  ...
  "dialog.provider.opensow.note": "Curated models including Claude, GPT, Gemini and more",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by OpenSow",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in OpenSow.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opensowZen.line1":
    "OpenSow Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.opensowZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.opensowZen.visit.prefix": "Visit ",
  "provider.connect.opensowZen.visit.link": "opensow.ai/zen",
  "provider.connect.opensowZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in OpenSow.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in OpenSow.",
  ...
  "dialog.plugins.empty": "Plugins configured in opensow.json",
  ...
  "dialog.server.description": "Switch which OpenSow server this app connects to.",
  ...
  "toast.update.description": "A new version of OpenSow ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the OpenSow team",
  ...
  "error.chain.checkConfig": "Check your config (opensow.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, OpenSow does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "OpenSow includes free models so you can start immediately.",
  ...
  "settings.general.row.language.description": "Change the display language for OpenSow",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how OpenSow looks on your device",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how OpenSow is themed.",
