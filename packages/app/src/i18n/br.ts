export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo OpenSow",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no OpenSow.",
  ...
  "provider.connect.opensowZen.line1":
    "OpenSow Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.opensowZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.opensowZen.visit.prefix": "Visite ",
  "provider.connect.opensowZen.visit.link": "opensow.ai/zen",
  "provider.connect.opensowZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no OpenSow.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no OpenSow.",
  ...
  "dialog.plugins.empty": "Plugins configurados em opensow.json",
  ...
  "dialog.server.description": "Trocar para qual servidor OpenSow este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do OpenSow ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do OpenSow",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (opensow.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: OpenSow ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "OpenSow inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do OpenSow",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o OpenSow aparece no seu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o OpenSow é tematizado.",
