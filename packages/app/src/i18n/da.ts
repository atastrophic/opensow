export const dict = {
  ...
  "command.session.shell": "Kør shell-kommando",
  "command.session.shell.description": "Kør en shell-kommando",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af OpenSow",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i OpenSow.",
  ...
  "provider.connect.opensowZen.line1":
    "OpenSow Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.opensowZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.opensowZen.visit.prefix": "Besøg ",
  "provider.connect.opensowZen.visit.link": "opensow.ai/zen",
  "provider.connect.opensowZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i OpenSow.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i OpenSow.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i opensow.json",
  ...
  "dialog.server.description": "Skift hvilken OpenSow-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af OpenSow ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til OpenSow-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (opensow.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, OpenSow understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "OpenSow inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for OpenSow",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan OpenSow ser ud på din enhed",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan OpenSow er temabestemt.",
