export const dict = {
  ...
  "command.session.shell": "Exécuter une commande shell",
  "command.session.shell.description": "Exécuter une commande shell",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par OpenSow",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans OpenSow.",
  ...
  "provider.connect.opensowZen.line1":
    "OpenSow Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  "provider.connect.opensowZen.line2":
    "Avec une seule clé API, vous aurez accès à des modèles tels que Claude, GPT, Gemini, GLM et plus encore.",
  "provider.connect.opensowZen.visit.prefix": "Visitez ",
  "provider.connect.opensowZen.visit.link": "opensow.ai/zen",
  "provider.connect.opensowZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans OpenSow.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans OpenSow.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans opensow.json",
  ...
  "dialog.server.description": "Changez le serveur OpenSow auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'OpenSow ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe OpenSow",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (opensow.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'OpenSow ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1": "OpenSow inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "app.name.desktop": "OpenSow Desktop",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour OpenSow",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'OpenSow sur votre appareil",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'OpenSow.",
