...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av OpenSow",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i OpenSow.",
  ...
  "provider.connect.opensowZen.line1":
    "OpenSow Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.opensowZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.opensowZen.visit.prefix": "Besøk ",
  "provider.connect.opensowZen.visit.link": "opensow.ai/zen",
  "provider.connect.opensowZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i OpenSow.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i OpenSow.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i opensow.json",
  ...
  "dialog.server.description": "Bytt hvilken OpenSow-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av OpenSow ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til OpenSow-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (opensow.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at OpenSow ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "OpenSow inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for OpenSow",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan OpenSow ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan OpenSow er tematisert.",
