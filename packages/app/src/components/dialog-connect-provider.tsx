import type { ProviderAuthAuthorization } from "@opensow-ai/sdk/v2/client"
...
import { List, type ListRef } from "@opensow-ai/ui/list"
              ...
              {iife(() => {
                ...
                return (
                  <div class="flex flex-col gap-6">
                    <Switch>
                      <Match when={provider().id === "opensow"}>
                        <div class="flex flex-col gap-4">
                          <div class="text-14-regular text-text-base">
                            {language.t("provider.connect.opensowZen.line1")}
                          </div>
                          <div class="text-14-regular text-text-base">
                            {language.t("provider.connect.opensowZen.line2")}
                          </div>
                          <div class="text-14-regular text-text-base">
                            {language.t("provider.connect.opensowZen.visit.prefix")}
                            <Link href="https://opensow.ai/zen" tabIndex={-1}>
                              {language.t("provider.connect.opensowZen.visit.link")}
                            </Link>
                            {language.t("provider.connect.opensowZen.visit.suffix")}
                          </div>
                        </div>
                      </Match>
                      <Match when={true}>
