import { useFilteredList } from "@opensow-ai/ui/hooks"
import {
  createEffect,
  on,
  Component,
...
import { FileIcon } from "@opensow-ai/ui/file-icon"
...
import { getDirectory, getFilename, getFilenameTruncated } from "@opensow-ai/util/path"
import { useDialog } from "@opensow-ai/ui/context/dialog"
import { ImagePreview } from "@opensow-ai/ui/image-preview"
...
import { createOpencodeClient, type Message, type Part } from "@opensow-ai/sdk/v2/client"
