import { FileDiff, Message, Model, Part, Session, SessionStatus, UserMessage } from "@opensow-ai/sdk/v2"
...
import { DiffComponentProvider } from "@opensow-ai/ui/context/diff"
import { CodeComponentProvider } from "@opensow-ai/ui/context/code"
import { WorkerPoolProvider } from "@opensow-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createEffect, createMemo, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@opensow-ai/ui/logo"
import { IconButton } from "@opensow-ai/ui/icon-button"
import { ProviderIcon } from "@opensow-ai/ui/provider-icon"
import { createDefaultOptions } from "@opensow-ai/ui/pierre"
...
import { Diff as SSRDiff } from "@opensow-ai/ui/diff-ssr"
import { clientOnly } from "@solidjs/start"
import { type IconName } from "@opensow-ai/ui/icons/provider"
import { Meta, Title } from "@solidjs/meta"
import { Base64 } from "js-base64"

const ClientOnlyDiff = clientOnly(() => import("@opensow-ai/ui/diff").then((m) => ({ default: m.Diff })))
const ClientOnlyCode = clientOnly(() => import("@opensow-ai/ui/code").then((m) => ({ default: m.Code })))
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@opensow-ai/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/opensow-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | OpenSow</Title>
              </Show>
              <Meta name="description" content="opensow - The AI coding agent built for the terminal." />
