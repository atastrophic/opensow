...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/opensow.git")).toEqual({ owner: "sst", repo: "opensow" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/opensow")).toEqual({ owner: "sst", repo: "opensow" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/opensow.git")).toEqual({ owner: "sst", repo: "opensow" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/opensow")).toEqual({ owner: "sst", repo: "opensow" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/opensow.git")).toEqual({ owner: "sst", repo: "opensow" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/opensow")).toEqual({ owner: "sst", repo: "opensow" })
})
