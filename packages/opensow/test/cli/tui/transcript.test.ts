...
import type { AssistantMessage, Part, UserMessage } from "@opensow-ai/sdk/v2"
...
describe("transcript", () => {
  describe("formatAssistantHeader", () => {
    ...
    test("includes metadata when enabled", () => {
      ...
      expect(result).toBe("## Assistant (Gartenmeister · claude-sonnet-4-20250514 · 5.4s)\n\n")
    })
    ...
    test("handles missing completed time", () => {
      ...
      expect(result).toBe("## Assistant (Gartenmeister · claude-sonnet-4-20250514)\n\n")
    })
  ...
  describe("formatMessage", () => {
    ...
    test("formats assistant message with metadata", () => {
      ...
      const result = formatMessage(msg, parts, options)
      expect(result).toContain("## Assistant (Gartenmeister · claude-sonnet-4-20250514 · 5.4s)")
  ...
  describe("formatTranscript", () => {
    test("formats complete transcript", () => {
      ...
      expect(result).toContain("## User")
      expect(result).toContain("Hello")
      expect(result).toContain("## Assistant (Gartenmeister · claude-sonnet-4-20250514 · 0.5s)")
    ...
    test("formats transcript without assistant metadata", () => {
      ...
      expect(result).not.toContain("Gartenmeister")
