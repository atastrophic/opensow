...
const mockPlugin = () => ({})
mock.module("opensow-copilot-auth", () => ({ default: mockPlugin }))
mock.module("opensow-anthropic-auth", () => ({ default: mockPlugin }))
mock.module("@gitlab/opensow-gitlab-auth", () => ({ default: mockPlugin }))
