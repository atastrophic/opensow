...
const TIPS = [
  ...
  "Press {highlight}Tab{/highlight} to cycle between Gartenmeister and Plan agents",
  "Use {highlight}/undo{/highlight} to revert the last message and file changes",
  "Use {highlight}/redo{/highlight} to restore previously undone messages and file changes",
  "Run {highlight}/share{/highlight} to create a public link to your conversation at opensow.ai",
  ...
  "Create {highlight}opensow.json{/highlight} in project root for project-specific settings",
  "Place settings in {highlight}~/.config/opensow/opensow.json{/highlight} for global config",
  ...
  "Add {highlight}.md{/highlight} files to {highlight}.opensow/command/{/highlight} to define reusable custom prompts",
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input",
  "Use backticks in commands to inject shell output (e.g., {highlight}`git status`{/highlight})",
  "Add {highlight}.md{/highlight} files to {highlight}.opensow/agent/{/highlight} for specialized AI personas",
  ...
  "OpenSow uses LSP servers for intelligent code analysis",
  "Create {highlight}.ts{/highlight} files in {highlight}.opensow/tool/{/highlight} to define new LLM tools",
  ...
  "Use {highlight}opensow run{/highlight} for non-interactive scripting",
  "Use {highlight}opensow --continue{/highlight} to resume the last session",
  "Use {highlight}opensow run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}opensow serve{/highlight} for headless API access to OpenSow",
  "Use {highlight}opensow run --attach{/highlight} to connect to a running server",
  "Run {highlight}opensow upgrade{/highlight} to update to the latest version",
  "Run {highlight}opensow auth list{/highlight} to see all configured providers",
  "Run {highlight}opensow agent create{/highlight} for guided agent creation",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/atasrophic/opensow{/highlight} for containerized use",
