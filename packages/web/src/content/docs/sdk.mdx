---
title: SDK
description: Type-safe JS client for opensow server.
---

import config from "../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

The opensow JS/TS SDK provides a type-safe client for interacting with the server.
Use it to build integrations and control opensow programmatically.
...
You can pass a configuration object to customize behavior. The instance still picks up your `opensow.json`, but you can override or add configuration inline:
...
console.log(`Server running at ${opensow.server.url}`)
...
If you already have a running instance of opensow, you can create a client instance to connect to it:
...
```typescript
import type { Session, Message, Part } from "@opensow-ai/sdk"
```
...
const textResults = await client.find.text({
  query: { pattern: "function.*opensow" },
})
