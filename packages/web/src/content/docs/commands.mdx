...
Create `.opensow/commands/test.md`:

```md title=".opensow/commands/test.md"
---
...
You can add custom commands through the OpenSow config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your OpenSow [config](/docs/config):

```json title="opensow.jsonc" {4-12}
{
...
- Global: `~/.config/opensow/commands/`
- Per-project: `.opensow/commands/`

```markdown title="~/.config/opensow/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".opensow/commands/component.md"
---
...
```md title=".opensow/commands/create-file.md"
---
...
```md title=".opensow/commands/analyze-coverage.md"
---
...
```md title=".opensow/commands/review-changes.md"
---
...
```md title=".opensow/commands/review-component.md"
---
...
opensow includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
