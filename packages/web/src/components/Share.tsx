...
import type { MessageV2 } from "opensow/session/message-v2"
import type { Message } from "opensow/session/message"
import type { Session } from "opensow/session/index"
        ...
        <div data-component="header">
          ...
          <div data-component="header-details">
            <ul data-component="header-stats">
              <li title="opensow version" data-slot="item">
                <div data-slot="icon" title="opensow">
