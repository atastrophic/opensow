...
export default function TermsOfService() {
  return (
    <main data-page="legal">
      <Title>OpenSow | Terms of Service</Title>
      <Link rel="canonical" href={`${config.baseUrl}/legal/terms-of-service`} />
      <Meta name="description" content="OpenSow terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to OpenSow. Please read on to learn the rules and restrictions that govern your use of OpenSow
              ...
              <p>
                ...
                <strong>ANOMALY INNOVATIONS, INC.</strong> ("OpenSow," "we" and "us"). Your use of the Services in any
                ...
                <a href="/legal/privacy-policy">https://opensow.ai/legal/privacy-policy</a>.{" "}
                <strong>
              ...
              <h2 id="what-is-opensow">What is OpenSow?</h2>
              <p>
                OpenSow is an AI-powered coding agent that helps you write, understand, and modify code using large
                language models. Certain of these large language models are provided by third parties ("Third Party
                Models") and certain of these models are provided directly by us if you use the OpenSow Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, OpenSow enables you to
              ...
              <p>
                ...
                our site located at opensow.ai, send you an email, and/or notify you by some other means.
              </p>
              ...
              <p>
                OpenSow takes the privacy of its users very seriously. For the current OpenSow Privacy Policy, please
                click here{" "}
                <a href="https://opensow.ai/legal/privacy-policy">https://opensow.ai/legal/privacy-policy</a>.
              </p>
              ...
              <h2 id="what-are-the-basics">What are the basics of using OpenSow?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by OpenSow;
                </li>
                <li>
              ...
              <p>
                If you use OpenSow with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                OpenSow. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                OpenSow has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-opensow-ever-change-the-services">Will OpenSow ever change the Services?</h2>
              <p>
              ...
              <p>
                ...
                Services"). Please see our Paid Services page <a href="/zen">https://opensow.ai/zen</a> for a
              ...
              <p>
                ...
                <a href="https://opensow.ai/auth">https://opensow.ai/auth</a>.
              </p>
              ...
              <p>
                ...
                <a href="/legal/privacy-policy">https://opensow.ai/legal/privacy-policy</a>, as well as the licenses
                above, to understand how we treat information you provide to us after you have stopped using our
                Services.
              </p>

              <p>
                OpenSow is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. OpenSow has the sole right to decide whether you are
              ...
              <p>
                OpenSow and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (OpenSow and all such
                parties together, the "OpenSow Parties") make no representations or warranties concerning the Services,
                including without limitation regarding any Content contained in or accessed through the Services, and
                the OpenSow Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
                ...
                participation in, the Services. The OpenSow Parties make no representations or warranties regarding
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the OpenSow Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without OpenSow's prior written
              ...
              <p>
                ...
                disputes and claims with OpenSow and limits the manner in which you can seek relief from OpenSow. Both
                you and OpenSow acknowledge and agree that for the purposes of any dispute arising out of or relating
                to the subject matter of these Terms, OpenSow's officers, directors, employees and independent
              ...
              <p>
                The Rules will govern payment of all arbitration fees. OpenSow will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. OpenSow will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or OpenSow may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                ...
                OF A JUDGE OR JURY. You and OpenSow are instead choosing to have claims and disputes resolved by
                ...
                you and OpenSow over whether to vacate or enforce an arbitration award, YOU AND OPENCODE WAIVE ALL
              ...
              <p>
                ...
                OpenSow is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or OpenSow to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and OpenSow agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the OpenSow may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and OpenSow agree that these
                Terms are the complete and exclusive statement of the mutual understanding between you and OpenSow, and
                ...
                are not an employee, agent, partner, or joint venture of OpenSow, and you do not have any authority of
                any kind to bind OpenSow in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and OpenSow
