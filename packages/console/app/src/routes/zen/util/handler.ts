...
import { and, Database, eq, isNull, lt, or, sql } from "@opensow-ai/console-core/drizzle/index.js"
import { KeyTable } from "@opensow-ai/console-core/schema/key.sql.js"
import { BillingTable, SubscriptionTable, UsageTable } from "@opensow-ai/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@opensow-ai/console-core/util/price.js"
import { getWeekBounds } from "@opensow-ai/console-core/util/date.js"
import { Identifier } from "@opensow-ai/console-core/identifier.js"
import { Billing } from "@opensow-ai/console-core/billing.js"
import { Actor } from "@opensow-ai/console-core/actor.js"
import { WorkspaceTable } from "@opensow-ai/console-core/schema/workspace.sql.js"
import { ZenData } from "@opensow-ai/console-core/model.js"
import { Black, BlackData } from "@opensow-ai/console-core/black.js"
import { UserTable } from "@opensow-ai/console-core/schema/user.sql.js"
import { ModelTable } from "@opensow-ai/console-core/schema/model.sql.js"
import { ProviderTable } from "@opensow-ai/console-core/schema/provider.sql.js"
...
export async function handler(
  ...
  const FREE_WORKSPACES = [
    ...
    "wrk_01K6W1A3VE0KMNVSCQT43BG2SX", // opensow bench
  ]
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-opensow-session") ?? ""
    const requestId = input.request.headers.get("x-opensow-request") ?? ""
    const projectId = input.request.headers.get("x-opensow-project") ?? ""
    const ocClient = input.request.headers.get("x-opensow-client") ?? ""
    logger.metric({
      is_tream: isStream,
      session: sessionId,
      request: requestId,
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetch(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-opensow-request")
          headers.delete("x-opensow-session")
          headers.delete("x-opensow-project")
          headers.delete("x-opensow-client")
          return headers
        })(),
        body: reqBody,
      })
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo) {
    ...
    if (!billing.paymentMethodID)
      throw new CreditsError(
        `No payment method. Add a payment method here: https://opensow.ai/workspace/${authInfo.workspaceID}/billing`,
      )
    if (billing.balance <= 0)
      throw new CreditsError(
        `Insufficient balance. Manage your billing here: https://opensow.ai/workspace/${authInfo.workspaceID}/billing`,
      )
    ...
    if (
      ...
      throw new MonthlyLimitError(
        `Your workspace has reached its monthly spending limit of $${billing.monthlyLimit}. Manage your limits here: https://opensow.ai/workspace/${authInfo.workspaceID}/billing`,
      )
    ...
    if (
      ...
      throw new UserLimitError(
        `You have reached your monthly spending limit of $${authInfo.user.monthlyLimit}. Manage your limits here: https://opensow.ai/workspace/${authInfo.workspaceID}/members`,
      )
