...
import desktopAppIcon from "../../asset/lander/opensow-desktop-icon.png"
...
export default function Download() {
  ...
  return (
    <main data-page="download">
      <Title>OpenSow | Download</Title>
      <Link rel="canonical" href={`${config.baseUrl}/download`} />
      <Meta name="description" content="Download OpenSow for macOS, Windows, and Linux" />
        ...
        <div data-component="content">
          <section data-component="download-hero">
            <div data-component="hero-icon">
              <img src={desktopAppIcon} alt="OpenSow Desktop" />
            </div>
            <div data-component="hero-text">
              <h1>Download OpenSow</h1>
          ...
          <section data-component="download-section">
            <div data-component="section-label">
              <span>[1]</span> OpenSow Terminal
            </div>
            <div data-component="section-content">
              <button
                data-component="cli-row"
                onClick={handleCopyClick("curl -fsSL https://opensow.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>opensow.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g opensow-ai")}>
                <code>
                  npm i -g <strong>opensow-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g opensow-ai")}>
                <code>
                  bun add -g <strong>opensow-ai</strong>
                </code>
                <CopyStatus />
              </button>
              ...
              <button data-component="cli-row" onClick={handleCopyClick("paru -S opensow")}>
                <code>
                  paru -S <strong>opensow</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            <div data-component="section-label">
              <span>[2]</span> OpenSow Desktop (Beta)
            </div>
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask opensow-desktop")}>
                <code>
                  brew install --cask <strong>opensow-desktop</strong>
                </code>
                <CopyStatus />
              </button>
          ...
          <section data-component="download-section">
            <div data-component="section-label">
              <span>[3]</span> OpenSow Extensions
            </div>
            <div data-component="section-content">
              <div data-component="download-row">
                <div data-component="download-info">
                ...
                <a href="https://opensow.ai/docs/ide/" data-component="action-button">
                  Install
                </a>
              </div>
          ...
          <section data-component="download-section">
            <div data-component="section-label">
              <span>[4]</span> OpenSow Integrations
            </div>
            <div data-component="section-content">
              <div data-component="download-row">
                <div data-component="download-info">
                ...
                <a href="https://opensow.ai/docs/github/" data-component="action-button">
                  Install
                </a>
              </div>
              ...
              <div data-component="download-row">
                ...
                <a href="https://opensow.ai/docs/gitlab/" data-component="action-button">
                  Install
                </a>
              </div>
            </div>
          ...
          <ul>
            <li>
              <Faq question="What is OpenSow?">
                OpenSow is an open source agent that helps you write and run code with any AI model. It's available as
            ...
            <li>
              <Faq question="Do I need extra AI subscriptions to use OpenSow?">
                Not necessarily, but probably. You'll need an AI subscription if you want to connect OpenSow to a paid
                provider, although you can work with{" "}
                <a href="/docs/providers/#lm-studio" target="_blank">
                  local models
                </a>{" "}
                for free. While we encourage users to use <A href="/zen">Zen</A>, OpenSow works with all popular
            ...
            <li>
              <Faq question="How much does OpenSow cost?">
                OpenSow is 100% free to use. Any additional costs will come from your subscription to a model provider.
                While OpenSow works with any model provider, we recommend using <A href="/zen">Zen</A>.
              </Faq>
            </li>
            <li>
              <Faq question="What about data and privacy?">
                Your data and information is only stored when you create sharable links in OpenSow. Learn more about{" "}
