...
import copyLogoSvgLight from "../asset/lander/opensow-logo-light.svg"
import copyLogoSvgDark from "../asset/lander/opensow-logo-dark.svg"
import copyWordmarkSvgLight from "../asset/lander/opensow-wordmark-light.svg"
import copyWordmarkSvgDark from "../asset/lander/opensow-wordmark-dark.svg"
  ...
  return (
    <section data-component="top">
      <div onContextMenu={handleLogoContextMenu}>
        <A href="/">
          <img data-slot="logo light" src={logoLight} alt="opensow logo light" width="189" height="34" />
          <img data-slot="logo dark" src={logoDark} alt="opensow logo dark" width="189" height="34" />
        </A>
      </div>
