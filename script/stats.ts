...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/atasrophic/opensow/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for atasrophic/opensow...\n")
...
console.log("Fetching npm all-time downloads for opensow-ai...\n")
const npmDownloads = await fetchNpmDownloads("opensow-ai")
