<p align="center">
  <a href="https://opensow.ai">
    <picture>
      ...
      <img src="packages/console/app/src/asset/logo-ornate-light.svg" alt="شعار OpenSow">
    </picture>
  </a>
</p>
...
4. `$HOME/.opensow/bin` - المسار الافتراضي الاحتياطي
...
يتضمن OpenSow وكيليْن (Agents) مدمجين يمكنك التبديل بينهما باستخدام زر `Tab`.
...
تعرف على المزيد حول [agents](https://opensow.ai/docs/agents).

### التوثيق

لمزيد من المعلومات حول كيفية ضبط OpenSow، [**راجع التوثيق**](https://opensow.ai/docs).

### المساهمة

اذا كنت مهتما بالمساهمة في OpenSow، يرجى قراءة [contributing docs](./CONTRIBUTING.md) قبل ارسال pull request.

### البناء فوق OpenSow

اذا كنت تعمل على مشروع مرتبط بـ OpenSow ويستخدم "opensow" كجزء من اسمه (مثل "opensow-dashboard" او "opensow-mobile")، يرجى اضافة ملاحظة في README توضح انه ليس مبنيا بواسطة فريق OpenSow ولا يرتبط بنا بأي شكل.
...
- 100% مفتوح المصدر
- غير مقترن بمزود معين. نوصي بالنماذج التي نوفرها عبر [OpenSow Zen](https://opensow.ai/zen)؛ لكن يمكن استخدام OpenSow مع Claude او OpenAI او Google او حتى نماذج محلية. مع تطور النماذج ستتقلص الفجوات وستنخفض الاسعار، لذا من المهم ان يكون مستقلا عن المزود.
- دعم LSP جاهز للاستخدام
- تركيز على TUI. تم بناء OpenSow بواسطة مستخدمي neovim ومنشئي [terminal.shop](https://terminal.shop)؛ وسندفع حدود ما هو ممكن داخل الطرفية.
- معمارية عميل/خادم. على سبيل المثال، يمكن تشغيل OpenSow على جهازك بينما تقوده عن بعد من تطبيق جوال. هذا يعني ان واجهة TUI هي واحدة فقط من العملاء الممكنين.

---

**انضم الى مجتمعنا** [Discord](https://discord.gg/opensow) | [X.com](https://x.com/opensow)
