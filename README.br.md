<p align="center">
  <a href="https://opensow.ai">
    <picture>
      ...
      <img src="packages/console/app/src/asset/logo-ornate-light.svg" alt="Logo do OpenSow">
    </picture>
  </a>
</p>
...
brew install anomalyco/tap/opensow # macOS e Linux (recomendado, sempre atualizado)
...
nix run nixpkgs#opensow           # ou github:anomalyco/opensow para a branch dev mais recente
```
...
O OpenSow também está disponível como aplicativo desktop. Baixe diretamente pela [página de releases](https://github.com/anomalyco/opensow/releases) ou em [opensow.ai/download](https://opensow.ai/download).
